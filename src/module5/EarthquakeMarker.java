...
public abstract class EarthquakeMarker extends CommonMarker {
  ...
  public void showTitle(PGraphics pg, float x, float y) {
    ...
    pg.popStyle();  // restore prior style settings
    // pushStyle() and popStyle() functions are always used together
    // They allow you to change the style settings and later return to what you had
    // When a new style is started with pushStyle(), it builds on the current style information
    // The pushStyle() and popStyle() functions can be embedded to provide more control
